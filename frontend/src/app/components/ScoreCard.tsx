    ...
    <div className="w-full max-w-md bg-brand-surface border border-brand-border p-6 rounded-xl shadow-2xl relative overflow-hidden transition-all duration-300">
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="relative flex items-center justify-center w-16 h-16">
          ...
          <div className={`absolute text-md font-bold text-brand-accent ${jetbrainsMono.className}`}>
            87
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 mb-6">
        <div>
          <div className="flex justify-between text-xs mb-1.5">
            <span className="text-brand-text-secondary">Technical Skill Match</span>
            <span className={`text-brand-accent ${jetbrainsMono.className}`}>92%</span>
          </div>
          <div className="h-1 bg-neutral-800 rounded-full overflow-hidden">
            <div className="h-full bg-brand-accent rounded-full" style={{ width: '92%' }}></div>
          </div>
        </div>

        <div>
          <div className="flex justify-between text-xs mb-1.5">
            <span className="text-brand-text-secondary">Relevant Experience</span>
            <span className={`text-brand-accent ${jetbrainsMono.className}`}>84%</span>
          </div>
          <div className="h-1 bg-neutral-800 rounded-full overflow-hidden">
            <div className="h-full bg-brand-accent rounded-full" style={{ width: '84%' }}></div>
          </div>
        </div>

        <div>
          <div className="flex justify-between text-xs mb-1.5">
            <span className="text-brand-text-secondary">Seniority Alignment</span>
            <span className={`text-brand-accent ${jetbrainsMono.className}`}>85%</span>
          </div>
          <div className="h-1 bg-neutral-800 rounded-full overflow-hidden">
      ...
      <div className="space-y-3 pt-4 border-t border-brand-border/60">
        <div>
          <div className="text-xs text-brand-text-secondary mb-2">Matched Skills</div>
        ...
        <div>
          <div className="text-xs text-brand-text-secondary mb-2">Missing Skills</div>
          <div className="flex flex-wrap gap-1.5">
